          ...
          <div className="relative z-20 mx-auto w-[260px] -mt-10 mb-6" style={{ filter: 'drop-shadow(6px 6px 0px rgba(0,0,0,0.9))' }}>
            ...
            >
              ...
              >
                ...
                >
                  <h1 className="text-3xl font-black text-[#FFE600] text-center leading-tight tracking-[0.05em]" style={{ textShadow: '2px 2px 0 #4a0000, -1px -1px 0 #4a0000, 1px -1px 0 #4a0000, -1px 1px 0 #4a0000, 1px 1px 0 #4a0000', WebkitTextStroke: '1px #4a0000' }}>
                    คำทำนาย
                  </h1>
                  <div className="flex items-center justify-center gap-2 mt-1">
                    ...
                    <h2 className="text-[34px] font-black text-[#FFE600] text-center leading-none tracking-wide" style={{ textShadow: '2px 2px 0 #4a0000, -1px -1px 0 #4a0000, 1px -1px 0 #4a0000, -1px 1px 0 #4a0000, 1px 1px 0 #4a0000', WebkitTextStroke: '1px #4a0000' }}>
                      บัวบุญ
                    </h2>
                    <img src="https://lh3.googleusercontent.com/d/1BXcEu8enzbjqVDk8bUs3ZtptKKm6TXp2" alt="flower" className="w-[20px] h-[20px] object-contain drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]" />
                  </div>
